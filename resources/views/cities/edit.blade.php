            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        ...
                        <span class="break"></span> Edit City
                    </h3>
                ...
                <div class="box-body">
                    ...
                    <form class="form-horizontal" action="{{ route('cities.update', $city->id) }}" id="edit_occupation_form" name="edit_occupation_form" method="POST">
