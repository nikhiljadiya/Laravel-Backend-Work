@extends('layouts.master')@section('title', 'Admin | Add User')
@section('content')
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            ...
                            <span class="break"></span> Add User </h3>
                    ...
                    <!-- Error Message End -->
                        ...
                        <form class="form-horizontal" action="{{ route('users.store') }}" id="add_user_form" name="add_user_form" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <label class="control-label col-sm-2" for="user_type">User Type
                            ...
                            <div class="form-group" id="users_list" style="display: none">
                                <label class="control-label col-sm-2" for="user_type">Users
                                    <span class="text-danger">*</span></label>
                                <div class="col-sm-4">
                                    <select name="user_ids[]" id="user_ids" class="form-control select2" style="width: 100%;" multiple required>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="password">Password
                                    <span class="text-danger">*</span></label>
                                <div class="col-sm-4">
                                    <input type="password" id="password" name="password" value="" class="form-control" required autocomplete="off">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-sm-2" for="occupation">City
                                    <span class="text-danger">*</span></label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <label class="col-sm-4">
                                        <input type="radio" name="status" value="1" class="minimal" checked>&nbsp;&nbsp;Active
                                    </label>
                                    <label class="col-sm-4">
                                        <input type="radio" name="status" value="0" class="minimal">&nbsp;&nbsp;Inactive
                                    </label>
                                </div>
                            </div>
